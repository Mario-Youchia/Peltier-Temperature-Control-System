...
![System identification models](public/images/projects/peltier-temperature-control-system/peltier-system-identification-models.png)

System identification produced multiple plant models. The simpler second-order model was selected for PID tuning because it kept a high fit while reducing model complexity.
...
![PID performance summary](public/images/projects/peltier-temperature-control-system/peltier-pid-performance-summary.png)

The reported digital-controller results compare the system response before and after applying PID control.
