 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Thu Jun 23 20:45:04 2022
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                DS18B20_Temp
...
extern void DS18B20_Temp_Outputs_wrapper(real_T *TempA,
  const real_T *xD);
extern void DS18B20_Temp_Update_wrapper(real_T *TempA,
  real_T *xD);
...
{
  real_T *TempA = (real_T *) ssGetOutputPortRealSignal(S, 0);
  const real_T *xD = ssGetDiscStates(S);
  DS18B20_Temp_Outputs_wrapper(TempA, xD);
}
...
static void mdlUpdate(SimStruct *S, int_T tid)
{
  ...
  DS18B20_Temp_Update_wrapper(TempA, xD);
}
